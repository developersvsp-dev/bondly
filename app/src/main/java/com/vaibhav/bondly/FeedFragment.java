    ...
    public class FeedFragment extends Fragment {
        ...
        private void updateFilterButtons() {
            int cyanColor = Color.parseColor("#5CE1E6");

            // 🔥 RESET: Normal colors for unselected
            btnFilterAll.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor("#F5F5F5")));
            btnFilterMale.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor("#E8F8F9")));
            btnFilterFemale.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor("#FFF0F2")));

            // 🔥 SELECTED: Cyan color
            switch (currentFilter) {
                case "all":
                    btnFilterAll.setBackgroundTintList(ColorStateList.valueOf(cyanColor));
                    break;
                case "male":
                    btnFilterMale.setBackgroundTintList(ColorStateList.valueOf(cyanColor));
                    break;
                case "female":
                    btnFilterFemale.setBackgroundTintList(ColorStateList.valueOf(cyanColor));
                    break;
            }
        }
